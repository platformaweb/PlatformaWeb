...
<div id="openModalRegister2" class="modalDialogRegister2">
			<div>
		<div class="cls"><a href="#close" title="Close" class="close">X</a></div>
		<div class= incp ><b>Username already exist...<br>Pleas try again!</b></div>
		<form method="post" action="register.php">
		First Name:<br>
		<input type="text" name="firstname">
		<br>
...
<div id="openModalRegister3" class="modalDialogRegister3">
			<div>
		<div class="cls"><a href="#close" title="Close" class="close">X</a></div>
		<div class= incp ><b>Email already exist or wrong format<br>Pleas try again!Format should be example@example.example</b></div>
		<form method="post" action="register.php">
		First Name:<br>
		<input type="text" name="firstname">
		<br>
